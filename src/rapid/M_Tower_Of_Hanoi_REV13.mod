MODULE M_Tower_Of_Hanoi
    ...
    PERS num NDH:=10;  !NOMINAL DISK HEIGHT
    PERS num NDD:=50;    !NOMINAL DISK DIAMETER
    PERS num NSL:=100;    !NOMINAL SHAFT LENGTH
    ...
    !WORKING DATA
    PERS num NShaft1X1:=-25;
    PERS num NShaft1Z1:=200;
    PERS num NShaft1Z2:=95;
    PERS num NShaft1Z3:=90;
    PERS num NShaft1Z4:=45;
    PERS num NShaft2X1:=-25;
    PERS num NShaft2Z1:=200;
    PERS num NShaft2Z2:=95;
    PERS num NShaft2Z3:=90;
    PERS num NShaft2Z4:=0;
    PERS num NShaft3X1:=-25;
    PERS num NShaft3Z1:=200;
    PERS num NShaft3Z2:=95;
    PERS num NShaft3Z3:=90;
