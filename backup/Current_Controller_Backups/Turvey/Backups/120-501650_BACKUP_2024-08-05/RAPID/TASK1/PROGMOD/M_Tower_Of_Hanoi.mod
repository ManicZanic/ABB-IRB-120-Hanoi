MODULE M_Tower_Of_Hanoi
    ...
    PERS num ProductionDataSTN1{3,3}:=[[0,0,0],[0,0,0],[0,0,0]];
    ...
    PERS num NOD:=4;    !NUMBER OF STACKED DISCS
    PERS num NStart:=2;  !START POSITION
    PERS num NEnd:=3;    !END POSITION
    PERS num NLoop:=1;   !LOOP COUNT
    PERS num NCountActive:=0;       !0 ENABLES ROBOT MoveMENT WHILE 1 DISABLES ROBOT MoveMENT
    PERS num NStepCount:=35;     !COMPLETED STEP COUNTER
    ...
    PROC R_Shaft_Stroke_Test()
        ...
        NOD:=4;!Set number of discs at start
        NCountActive:=0;!Set to 1 to disable motion. Set to 0 to resume motion.
...
NOD:=NOD;
    ...
    IF NCountActive=0 then
        if NStart=1 then
            MoveJ offs(Shaft1,NShaft1X1,0,NShaft1Z1),v300,z5,tGripperTool\Wobj:=wobjTower;
            MoveL offs(Shaft1,NShaft1X1,0,NShaft1Z4),v300,z5,tGripperTool\Wobj:=wobjTower;
            MoveL offs(Shaft1,0,0,NShaft1Z4),v300,fine,tGripperTool\Wobj:=wobjTower;
            !CLOSE GRIPPER
            !        PulseDO \PLength:=1, DO_GripperClose;
            WaitTime 0.2;
            !WaitDI DI_GripperClosed,1 \MaxTime:=0.5;
            MoveL offs(Shaft1,0,0,NShaft1Z1),v300,z5,tGripperTool\Wobj:=wobjTower;
            NShaft1Z4:=NShaft1Z4-NDH;
        ENDIF
        if NStart=2 then
            MoveJ offs(Shaft2,NShaft2X1,0,NShaft2Z1),v300,z5,tGripperTool\Wobj:=wobjTower;
            MoveL offs(Shaft2,NShaft2X1,0,NShaft2Z4),v300,z5,tGripperTool\Wobj:=wobjTower;
            MoveL offs(Shaft2,0,0,NShaft2Z4),v300,fine,tGripperTool\Wobj:=wobjTower;
            !CLOSE GRIPPER
            !        PulseDO \PLength:=1, DO_GripperClose;
            WaitTime 0.2;
            !WaitDI DI_GripperClosed,1 \MaxTime:=0.5;
            MoveL offs(Shaft2,0,0,NShaft2Z1),v300,z5,tGripperTool\Wobj:=wobjTower;
            NShaft2Z4:=NShaft2Z4-NDH;
        ENDIF
        if NStart=3 then
            MoveJ offs(Shaft3,NShaft3X1,0,NShaft3Z1),v300,z5,tGripperTool\Wobj:=wobjTower;
            MoveL offs(Shaft3,NShaft3X1,0,NShaft3Z4),v300,z5,tGripperTool\Wobj:=wobjTower;
            MoveL offs(Shaft3,0,0,NShaft3Z4),v300,fine,tGripperTool\Wobj:=wobjTower;
            !CLOSE GRIPPER
            !        PulseDO \PLength:=1, DO_GripperClose;
            WaitTime 0.2;
            !WaitDI DI_GripperClosed,1 \MaxTime:=0.5;
            MoveL offs(Shaft3,0,0,NShaft3Z1),v300,z5,tGripperTool\Wobj:=wobjTower;
            NShaft3Z4:=NShaft3Z4-NDH;
        ENDIF
        if NEnd=1 then
            MoveJ offs(Shaft1,0,0,NShaft1Z1),v300,z5,tGripperTool\Wobj:=wobjTower;
            MoveL offs(Shaft1,0,0,NShaft1Z2),v300,fine,tGripperTool\Wobj:=wobjTower;
            !OPEN GRIPPER
            !        PulseDO \Plength:=1,DO_GripperClose;
            WaitTime 0.2;
            !WaitDI DI_GripperOpened,1 \MaxTime:=0.5;
            MoveL offs(Shaft1,NShaft1X1,0,NShaft1Z3),v300,z0,tGripperTool\Wobj:=wobjTower;
            MoveL offs(Shaft1,0,0,NShaft1Z1),v300,z5,tGripperTool\Wobj:=wobjTower;
            NShaft1Z4:=NShaft1Z4+NDH;
        ENDIF
        if NEnd=2 THEN
            MoveJ offs(Shaft2,0,0,NShaft2Z1),v300,z5,tGripperTool\Wobj:=wobjTower;
            MoveL offs(Shaft2,0,0,NShaft2Z2),v300,fine,tGripperTool\Wobj:=wobjTower;
            !OPEN GRIPPER
            !        PulseDO \Plength:=1,DO_GripperClose;
            WaitTime 0.2;
            !WaitDI DI_GripperOpened,1 \MaxTime:=0.5;
            MoveL offs(Shaft2,NShaft2X1,0,NShaft2Z3),v300,z0,tGripperTool\Wobj:=wobjTower;
            MoveL offs(Shaft2,0,0,NShaft2Z1),v300,z5,tGripperTool\Wobj:=wobjTower;
            NShaft2Z4:=NShaft2Z4+NDH;
        ENDIF
        IF NEnd=3 THEN
            MoveJ offs(Shaft3,0,0,NShaft3Z1),v300,z5,tGripperTool\Wobj:=wobjTower;
            MoveL offs(Shaft3,0,0,NShaft3Z2),v300,fine,tGripperTool\Wobj:=wobjTower;
            !OPEN GRIPPER
            !        PulseDO \Plength:=1,DO_GripperClose;
            WaitTime 0.2;
            !WaitDI DI_GripperOpened,1 \MaxTime:=0.5;
            MoveL offs(Shaft3,NShaft3X1,0,NShaft3Z3),v300,z0,tGripperTool\Wobj:=wobjTower;
            MoveL offs(Shaft3,0,0,NShaft3Z1),v300,z5,tGripperTool\Wobj:=wobjTower;
            NShaft3Z4:=NShaft3Z4+NDH;
        ENDIF
    ENDIF 
